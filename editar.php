            ...
            <div class="row">
                <div class="col">
                    <form class="row g-3" method="POST" action="guarda.php" autocomplete="off">
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-secondary" href="index.php"><i class="bi bi-arrow-return-left"></i></a>
                            <button type="submit" class="btn btn-primary" name="registro"><i class="bi bi-floppy"></i></button>
                        </div>
